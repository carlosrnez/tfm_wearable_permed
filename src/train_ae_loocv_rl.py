...
ACTIVITIES_TO_BE_REMOVED=['TAPIZ RODANTE', 'YOGA', 'ACTIVIDAD NO ESTRUCTURADA']
...
for loop, (X_train, X_validation, X_test, y_train, y_validation, y_test, m_train, m_validation, m_test) in enumerate(data_iterator, start=1):    
    ...
    acc_score_validation = accuracy_score(y_test, y_test_pred)
    f1_score_validation = f1_score(y_test, y_test_pred, average='macro')
